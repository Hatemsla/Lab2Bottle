% rebase('layout.tpl', year=year, data_clients=data_clients, required_product=required_product, name_company=name_company)
...
<div class="wrapper" style="margin-top:50px">
    <div class="intro">
        <div class="profile">
            <div class="photo">
                <img class="color-icon-white" src="\static\images\icon\new_client.svg"  alt="Картинка заказов и сотрудничества">
            </div>
            <div class="bio">
